...
sys.path.append('../')
import numpy as np
from ddfalib import render
from ddfalib.cython import mesh_core_cython
...
class RenderPipeline(object):
    ...
    def __call__(self, vertices, triangles, background,colors):
        ...
        '''
        #color=1.0-get_colors(background,vertices) /255.0
        color=colors
